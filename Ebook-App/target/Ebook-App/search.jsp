					...
					<div class="card-body text-center">
						<div class="css-img-index">
							<div>
								...
								<img data-perfmatters-preload="" width="110" height="150" src="book/python.jpg<%-- <%=b.getPhotoName()%> --%>" sizes="(max-width: 110px) 100vw, 110px" class="img-responsive" style="border: 1px solid #a6a2a2;" alt="the-gioi-khong-xxoo">
							</div>
							<div class="book-info">
